...
numeric_features = [ "Age", "DurationOfPitch", "NumberOfPersonVisiting",
...
param_grid = {
    ...
    'xgbclassifier__learning_rate': [0.01, 0.025, 0.05, 0.1],
    'xgbclassifier__reg_lambda': [0.01, 0.1, 1],
}
# Model pipeline
...
with mlflow.start_run():
    ...
    model_path = "tourism_project/deployment/tourism.joblib"
